    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <div class="mb-4">
                    <a href="index.php" class="inline-flex items-center text-sm text-gray-600 hover:text-primary-600 transition-colors">
                ...
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div class="relative">
                        ...
                        <input id="confirm-password" name="confirm-password" type="password" placeholder=" " autocomplete="new-password" required
                            class="peer w-full border-b-2 border-gray-300 focus:border-primary-500 outline-none py-2 pl-10 text-gray-900">
                        <label for="confirm-password"
                            class="absolute left-10 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-base peer-focus:-top-3.5 peer-focus:text-sm peer-focus:text-primary-500">
                            Confirm Password
                        </label>
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onclick="togglePasswordVisibility('confirm-password')">
                            <i data-feather="eye" class="h-5 w-5 text-gray-400" id="confirm-password-eye"></i>
                        </div>
                    </div>

                    <div>
                        <button type="submit" class="w-full flex justify-center py-2 px-4 rounded-md text-sm font-medium text-white bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 focus:outline-none transition-colors">
                            Create Account
                        </button>
                    </div>
                </form>
